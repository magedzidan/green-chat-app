  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SignUpViewmodel>(
      create: (BuildContext context) =>
          SignUpViewmodel(AuthService(), DatabaseSerice(),StorageService()),
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                      ...
                      child: modle.image == null
                          ? CircleAvatar(
                              child: Icon(Icons.camera_alt),
                              radius: 45.r,
                            )
                          : CircleAvatar(
                              backgroundImage: FileImage(modle.image!),
                              radius: 45.r,
                            )),
                  20.verticalSpace,
                  CustomFormField(
                  ...
                  CustomButton(
                    ...
                    onPressed: modle.state == ViewState.loading
                        ? null
                        : () async {
                            try {
                              await modle.signUp();
                              ...
                              Navigator.pop(
                                  context); //3shan el msh hynf3 nrg3 3la el login 3la tol 3hsan 2hna sh8len on wrapper screen
